...
function h5bs_enqueue_styles()
{
  ...
  wp_enqueue_style('h5bs-bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css', false, '1.0.0');
...
function h5bs_enqueue_scripts()
{
  ...
  wp_enqueue_script('h5bs_bootstrap_js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js', [], '1.0.0', true);
}
